 ...
 */
[_LOWER] = LAYOUT(
  KC_GRAVE, DM_REC1, DM_REC2, DM_PLY1, DM_PLY2, DM_RSTP,                   _______, _______, _______,_______, _______, _______,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | Mute | Vol- | Play | Vol+ |  (   |-------.    ,-------|   )  | Left | Down |  Up  |Right |      |
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|   +  |   =  |   [  |   ]  |   \  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LOWER | LGUI | Alt  | /Space  /       \Enter \  |BackSP| RGUI |RAISE |
...
[_RAISE] = LAYOUT(
  KC_GRAVE, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_4, KC_KP_5,                     KC_KP_6, KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_0, _______,
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                       KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
  _______, KC_MUTE, KC_VOLD, KC_MPLY, KC_VOLU, _______,                     XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,
...
#ifdef LED_INDICATORS_ENABLE = yes
